...
class lumpurlabu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lumpurlabu)
        vVideo = findViewById<VideoView>(R.id.videolumpur) as VideoView
