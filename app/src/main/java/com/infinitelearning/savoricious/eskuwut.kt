...
class eskuwut : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eskuwut)

        vVideo = findViewById(R.id.vwvidiokuwut) as VideoView
        ...
        vVideo!!.setVideoURI(
            Uri.parse("android.resource://"
                + packageName + "/" + R.raw.eskuwuttimun))
