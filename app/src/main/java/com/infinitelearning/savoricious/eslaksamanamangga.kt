...
class eslaksamanamangga : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eslaksamanamangga)
        vVideo = findViewById(R.id.videoesmangga)
        ...
        vVideo!!.setVideoURI(
            Uri.parse("android.resource://"
                + packageName + "/" + R.raw.laksamanggga))
