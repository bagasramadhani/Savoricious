...
class tulangsup : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tulangsup)

        vVideo = findViewById<VideoView>(R.id.vwvidiotulang) as VideoView
