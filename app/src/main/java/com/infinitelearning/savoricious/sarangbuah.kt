...
class sarangbuah : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sarangbuah)

        vVideo = findViewById<VideoView>(R.id.vidieosarangbuah) as VideoView
        ...
        vVideo!!.setVideoURI(
            Uri.parse("android.resource://"
                + packageName + "/" + R.raw.essarangburung))
